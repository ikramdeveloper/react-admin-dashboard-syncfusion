        ...
        >
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-2xl">$524,444,333</p>
            </div>
            <button
              type="button"
        ...
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-3 rounded-2xl md:w-780">
          ...
          <div className="mt-10 flex gap-10 flex-wrap justify-center">
            <div className="border-r-1 border-color m-4 pr-10">
              <div>
                <p>
                  <span className="text-3xl font-semibold">$93,343</span>
              ...
              <div className="mt-8">
                <p>
                  <span className="text-3xl font-semibold">$78,434</span>
                </p>
          ...
          <div className="mt-10">
            ...
            <div className="mt-8">
              <p className="font-semibold text-lg">
                Ikram coming to the world!
              </p>
              <p className="text-gray-400 ">By Simon Doe</p>
